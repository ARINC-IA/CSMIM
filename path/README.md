...
Please note that the domain does not define a security level for the data itself, but indicates from which security level the information is originating.
